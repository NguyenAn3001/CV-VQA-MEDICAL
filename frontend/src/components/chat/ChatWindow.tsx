      ...
      <AnimatePresence>
        {showScrollButton && (
          <motion.button
            ...
            className="absolute bottom-36 left-1/2 -translate-x-1/2 flex items-center justify-center gap-1.5 px-3 py-2 bg-white border border-slate-200 shadow-md rounded-full text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition-colors z-20 text-sm font-medium"
          >
