...
from app.schemas.auth import RegisterRequest, LoginRequest, RefreshRequest, ChangePasswordRequest, LogoutRequest
...
class AuthService:
    ...
    async def refresh_token(self, db: AsyncSession, redis_client: redis.Redis, req: RefreshRequest) -> dict:
    ...
    async def logout(self, redis_client: redis.Redis, access_token: str, req: Optional[LogoutRequest] = None) -> dict:
    ...
    async def change_password(self, db: AsyncSession, current_user: User, req: ChangePasswordRequest) -> dict:
